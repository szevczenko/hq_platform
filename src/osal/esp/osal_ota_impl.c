...
osal_status_t osal_ota_begin(const osal_ota_descriptor_t *descriptor)
{
    ...
    osal_log_info("[osal_ota] ESP dummy begin: title=%s version=%s size=%zu",
...
osal_status_t osal_ota_finish(bool apply_update)
{
    ...
    osal_log_info("[osal_ota] ESP dummy finish: apply=%d written=%zu",
...
osal_status_t osal_ota_abort(void)
{
    ...
    osal_log_warning("[osal_ota] ESP dummy abort");
    return OSAL_SUCCESS;
}
